    ...
    return (
        <div className='lg:bg-hero-layer bg-no-repeat max-lg:bg-center bg-cover lg:min-h-[748px] relative' id='home'>
            <div className='container'>
                <div className='lg:flex-row flex-col flex justify-between lg:pt-[143px] md:pt-20 pt-12 gap-5'>
                    <div className='lg:w-[570px] w-full flex flex-col justify-center'>
                        <div className='flex flex-col justify-center max-lg:items-center'>
                            <h1 className='lg:text-custom-5xl lg:leading-custom-5xl lg:text-[64px] sm:text-5xl sm:leading-custom-4xl text-4xl font-sunflower text-white uppercase lg:max-w-[570px] max-lg:text-center'>We are believers decentralization <img className='ms-[142px] max-w-[158px] w-full lg:block hidden' src="/assets/images/webp/hero-second-line.webp" alt="second-line" /> And Web3.
                                <img className='ms-[111px] max-w-[169px] w-full lg:block hidden' src="./assets/images/webp/hero-first-line.webp" alt="first-line" />
                            </h1>
                            <Description classStyle={'lg:max-w-[495px] pt-1 max-lg:text-center !leading-custom-2xl'} text={'Vulputate tristique habitant neque, accumsan. Vitae ultrices nulla erat nibh aliquam, quis tempus volutpat arcu. Leo convallis luctus dis malesuada turpis non consequat ac.'} />
