                ...
                <div className='lg:flex-row flex-col flex justify-between lg:pt-[143px] md:pt-14 pt-10 gap-5'>
                    <div className='lg:w-[570px] w-full flex flex-col justify-center'>
                        <div className='flex flex-col justify-center max-lg:items-center'>
                            <h1 className='lg:text-[64px] sm:text-5xl sm:leading-custom-sm text-4xl font-sunflower text-white uppercase lg:max-w-[570px] max-lg:text-center'>We are believers decentralization <img className='ms-[158px] max-w-[158px] w-full lg:block hidden' src="./assets/images/png/hero-second-line.png" alt="second-line" /> And Web3.
                                <img className='ms-[111px] max-w-[169px] w-full lg:block hidden' src="./assets/images/png/hero-first-line.png" alt="first-line" />
                            </h1>
